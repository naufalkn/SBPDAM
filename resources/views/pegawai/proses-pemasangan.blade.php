                ...
                <div
                    ...
                    <div class="flex w-full gap-10 items-center p-5">
                        ...
                        <div class="flex flex-col justify-between leading-normal">
                            <h5 class="mb-2 text-base font-bold tracking-tight text-green-800 dark:text-white">Proses Pemasangan
                            </h5>
                            <p class="mb-3 text-2xl text-green-800 dark:text-gray-400 font-bold">
                                {{ $listProses }}</p>
                        </div>
                    </div>
                </div>
