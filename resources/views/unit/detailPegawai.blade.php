                    ...
                    <div class="space-y-16">
                        <div
                            ...
                            <div class="h-3/4 w-full flex items-center">
                                <img src="{{ asset('img/' . $pegawai->user->foto) }}" alt=""
                            ...
                            <div class="divide-y divide-gray-200 space-y-3">
                                ...
                                <div class="flex w-full">
                                    <div class="flex flex-col pb-3 w-1/2 ">
                                        ...
                                        <p class="font-semibold ">{{ $pegawai->user->nama }}</p>
                                    </div>
                                    <div class="flex flex-col pb-3 w-1/2">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Jenis Kelamin</p>
                                        <p class="font-semibold">
                                            @if ($pegawai->user->jenis_kelamin == 'L')
                                                Laki-laki
                                            @elseif($pegawai->user->jenis_kelamin == 'P')
                                                Perempuan
                                            @endif
                                        </p>
                                    </div>
                                ...
                                <div class="flex w-full">
                                    ...
                                    <div class="flex flex-col pb-3 w-1/2">
                                        ...
                                        <p class="font-semibold">{{ $pegawai->nm_unit }} / {{ $pegawai->kd_unit }}</p>
                                    </div>
                                </div>
                                <div class="flex w-full">
                                    <div class="flex flex-col pb-3 w-1/2 ">
                                    ...
                                    <div class="flex flex-col pb-3 w-1/2">
                                        ...
                                        <p class="font-semibold">{{ $pegawai->created_at->format('d-m-Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
