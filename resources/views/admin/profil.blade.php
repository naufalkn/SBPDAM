...
@section('container')
    ...
    <form action="{{ url('/updateProfilSuperadmin', auth()->user()->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-16">
                        <div
                            ...
                            <div class="h-3/4 w-full flex units-center">
                                <img src="{{ asset('img/' . $admin->foto) }}" alt=""
                            ...
                            <div class="text-center divide-y dark:divide-gray-300">
                                <div class="my-2 space-y-1">
                                    <h2 class="text-lg uppercase font-bold">{{ $admin->nama }}</h2>
                                </div>
                            </div>
                            <input
                    ...
                    <div
                        ...
                        <div class=" w-full space-y-4 text-gray-900  dark:text-white dark:divide-gray-700">
                            <div class="divide-y divide-gray-200 space-y-3">
                                <p class="font-bold text-2xl text-blue-800">Profil Superadmin</p>
                                <div class="flex w-full">
                                    <div class="flex flex-col pb-3 w-1/2 ">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Nama</p>
                                        <input type="text" name="nama" id="nama"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-3/4 p-2.5"
                                            placeholder="Masukkan Alamat Email Anda" value="{{ $admin->nama }}">
                                    </div>
                                    <div class="flex flex-col pb-3 w-1/2 ">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Username</p>
                                        <input type="text" name="username" id="username"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-3/4 p-2.5"
                                            placeholder="Masukkan Alamat Email Anda" value="{{ $admin->username }}">
                                    </div>
                                </div>
                                <div class="flex w-full">
                                    <div class="flex flex-col pb-3 w-1/2 ">
