    ...
    <div class="font-sans">
        ...
        <div class="flex relative">
            ...
            <div class="w-full flex">
                        ...
                        <div
                            ...
                            <div class="space-y-4 text-center divide-y dark:divide-gray-300">
                                <div class="my-2 space-y-1">
                                    <h2 class="text-xl font-semibold sm:text-2xl">Naufal Khoirun Nafi</h2>
                ...
                {{-- Informasi --}}
                <div class="p-5 h-svh w-full">
                    @foreach($pelanggan as $item)
                    <div
                        class="h-screen w-full  p-6 shadow-xl rounded-xl sm:px-12 bg-white dark:bg-green-50 dark:text-gray-800">
