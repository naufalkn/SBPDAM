                            ...
                            <div class="w-2/3 p-2">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    @if (auth()->user()->pelanggan)
                                        ...
                                        @elseif (auth()->user()->pelanggan->status == 1)
                                            <p class="text-sm">Sudah diverifikasi</p>
                                        @elseif (auth()->user()->pelanggan->status == 2)
                                            <p class="text-sm">Proses Pemasangan</p>
                                        @elseif (auth()->user()->pelanggan->status == 3)
                                            <p class="text-sm">Menunggu Aktifasi</p>
                                        @elseif (auth()->user()->pelanggan->status == 4)
                                            <p class="text-sm">Berlangganan</p>
                                        @elseif (auth()->user()->pelanggan->status == 5 ||
                                                auth()->user()->pelanggan->status == 6 ||
                                                auth()->user()->pelanggan->status == 7 ||
                                                auth()->user()->pelanggan->status == 8)
                                            <p class="text-sm">Pengajuan Berhenti Berlangganan</p>
                                        @elseif (auth()->user()->pelanggan->status == 9)
                    ...
                    <div id="myTabContent" class="w-full h-full">
                        ...
                        <div class=" h-full space-y-4 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full hidden"
                            ...
                            @if (auth()->user()->pelanggan)
                                ...
                                {{-- Status --}}
                                {{-- Pengajuan --}}
                                @if ($pelanggan->status == 5 || $pelanggan->status == 6 || $pelanggan->status == 7 || $pelanggan->status == 8)
                                    <div class="p-4 h-40 w-full rounded-lg border-[1px] border-gray-300">
                                        <div class="">
                                            <div class="w-full px-24 py-4">
                                                <div class="relative flex items-center justify-between w-full">
                                                    ...
                                                    @elseif($pelanggan->status == 8 || $pelanggan->status == 9)
                                                        <div
                                                    ...
                                                    @endif
                                                    @if ($pelanggan->status == 6 || $pelanggan->status == 7 || $pelanggan->status == 8 || $pelanggan->status == 9)
                                                        <div
                                                    ...
                                                    @if ($pelanggan->status == 8 || $pelanggan->status == 9)
                                                        <div
                                                            class="relative z-10 grid w-10 h-10 font-bold text-white transition-all duration-300 bg-red-500 rounded-full place-items-center">
