        ...
        <div class=" w-full p-14">
            <div
                ...
                @elseif (auth()->user()->pelanggan && auth()->user()->pelanggan->tgl_daftar != null)
                    <p class="p-2 w-full text-2xl dark:text-gray-400">Pendaftaran Anda Sedang Diproses</p>
                @else
                    <p class="p-2 w-full text-2xl dark:text-gray-400">Mari Mulai Berlangganan dan Nikmati Layanan Air Bersih
                    </p>
                    <div class="">
