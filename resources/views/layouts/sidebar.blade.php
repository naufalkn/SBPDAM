        {{-- <nav class="absolute md:relative w-64 transform -translate-x-full md:translate-x-0 h-screen overflow-y-scroll bg-blue-600 transition-all duration-300" :class="{'-translate-x-full': !navOpen}">
            <div class="flex flex-col justify-between h-full">
                <div class="p-4">
                    <!-- LOGO -->
                    <a class="flex items-center text-white space-x-4" href="">
                        <span class="text-2xl font-bold">PDAM SRAGEN</span>
                    </a>

                    <!-- NAV LINKS -->
                    <div class="py-4 text-gray-400 space-y-1">
                        <!-- BASIC LINK -->
                        <a href="#" class="py-2.5 px-4 flex items-center space-x-2 text-white hover:bg-blue-800 hover:text-white rounded">
                        ...
                        <div class="">
                            <x-sidebar-menu text="Dashoard" href="/dashboard" :isActive="Request::is('beranda*')" />
                            <x-sidebar-menu text="Dashoard" href="/dashboard" :isActive="Request::is('beranda*')" />
                        </div>
                        <!-- DROPDOWN LINK -->
                ...
                <div class="text-gray-200 border-gray-800 rounded flex items-center justify-between p-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <img src="https://ui-avatars.com/api/?name=Habib+Mhamadi&size=128&background=ff4433&color=fff" class="w-7 rounded-full" alt="Profile">
                        <h1>{{ $nama }}</h1>
                    </div>
        ...
        <nav class="absolute md:relative w-72 transform -translate-x-full md:translate-x-0 h-screen transition-all duration-300">
            <div class="flex flex-col justify-between h-full">
            ...
            <aside id="cta-button-sidebar"
                class="fixed top-0 left-0 z-40 h-screen transition-transform w-11/12 sm:translate-x-0"
                aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 border-r-2">
                    <!-- LOGO -->
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <div href="/daftar-manual" class="flex items-center p-2">
                                <x-sidebar-menu text="Daftar" icon="fa-solid fa-user-plus" href="/daftar-manual" :isActive="Request::is('daftar-manual*')" />
                            </div>
                        </li>
                        <li>
                            <a href="#"
                ...
                <!-- PROFILE -->
                <div class="p-3 ">
                    <a href="{{ url('/logout') }}" type="submit" class="text-white bg-red-800 w-full h-12 border-gray-800 rounded flex items-center justify-between p-2">
